...
def _get_criterion(args):
    ...
    return ce_criterion
# train() uses CrossEntropyLoss for multi-class classification (TU/MNIST) vs BCEWithLogitsLoss for OGB binary. 
...
# eval() computes accuracy for non-molecular datasets.
